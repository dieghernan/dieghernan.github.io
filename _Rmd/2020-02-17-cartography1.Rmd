...
```{r 20201702_hatched-min, fig.height=7, fig.width=7, margin=TRUE}
library(sf)
library(jsonlite)
library(dplyr)
...
```{r 20201702_hatched, fig.height=7, fig.width=7, margin=TRUE}
library(sf)
library(cartography)
...
```{r 20201702_hatched-adv, fig.height=7, fig.width=7, margin=TRUE}
...
```{r 20201702_pnglayer, fig.height=7, fig.width=5, margin=TRUE}
library(sf)
library(cartography)
...
```{r 20201702_png-adv, fig.height=5, fig.width=7, margin=TRUE}
...
```{r 20201702_wordcloud1, fig.height=7, fig.width=7, margin=TRUE}
...
### Example 2
```{r 20201702_wordcloud2, fig.height=7, fig.width=7, margin=TRUE}
