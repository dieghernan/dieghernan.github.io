...
```{r 20191212_gridex,  message=FALSE, warning=FALSE, dpi=90,fig.width=200/90, fig.height=350/90, paged.print=FALSE, tidy='styler', results='hide'}
# Grid
grid = st_make_grid(DE,
                    what = "polygons",
                    square = T) %>%
...
```{r 20191212_horex1, warning=FALSE, message=FALSE, tidy='styler', fig.width=200/90, fig.height=350/90, dpi=90 }
# Horizontal
grid = st_make_grid(DE,
                    what = "polygons",
                    square = T)
...
```{r 20191212_horex2, warning=FALSE, message=FALSE, tidy='styler', fig.height=350/90,fig.width=200/90, dpi=90 }
