...
```{r 20190602_preparing, fig.align='center', message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
GB  <- ne_download(50,
                   type = "map_subunits",
                   returnclass = "sf",
                   destdir = tempdir()) %>%
...
```{r 20190602_squares, warning=FALSE, message=FALSE, tidy='styler',fig.width=500/90, fig.height=350/90, dpi=90, fig.align='center'}
...
```{r 20190602_hex, warning=FALSE, message=FALSE, tidy='styler',fig.width=500/90, fig.height=350/90, dpi=90, fig.align='center'}
...
```{r 20190602_pix, warning=FALSE, message=FALSE, tidy='styler',fig.width=250/90, fig.height=350/90, dpi=90, fig.align='center'}
grid = st_make_grid(target,
                    50*1000, # Kms
                    crs = st_crs(initial),
                    what = "centers")
...
```{r 20190602_function, warning=FALSE, message=FALSE, tidy='styler',fig.width=500/90, fig.height=3*350/90, dpi=90, fig.align='center'}
...
```{r 20190602_functionex, echo=FALSE, fig.align='center', fig.height=2*350/90, fig.width=750/90, message=FALSE, warning=FALSE, dpi=90, tidy='styler'}
