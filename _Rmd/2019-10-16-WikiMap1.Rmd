...
```{r 20191016_final, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, results='hide' }
...
**Update**: The map is already part of the Wikipedia article [[link](https://en.wikipedia.org/wiki/International_organ_donor_rates#Global_Summary).
{: .alert .alert-danger .p-3 .mx-2 .mb-3 }]

```{r 20191016_imgpost, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE, results='hide'}
