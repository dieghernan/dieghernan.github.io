...
"joyplots" with **R** for specific regions of the world using elevation data to
create the ridges.
...
needed. In this case both are in meters, but I show you how to perform
...
```{r 20220501_andalucia_ridges_dens}
