...
SPAIN = get_eurostat_geospatial(resolution = "03", nuts_level = "2") %>%
  subset(CNTR_CODE == "ES") %>% st_transform(3857)
...
```{r 20190618_svg, fig.align='center', message=FALSE, warning=FALSE, dev='png', fig.width=800/(90),fig.height=550/(90),dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
