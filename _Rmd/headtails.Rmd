...
```{r 20200405_stepbystep,dev.args=list(bg = NA), message=FALSE, warning=FALSE, dpi=90, paged.print=FALSE, tidy='styler', results='hide'}
...
The resulting breaks are then defined as `breaks = c(min(var), mu(iter=1), ..., mu(iter=last), max(var))`.
