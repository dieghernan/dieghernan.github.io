...
This is a quick post on how to create a map according to the [Wikipedia conventions](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Maps/Conventions#Gradient_maps). In this case, I have chosen to plot the [international organ donor rates](https://en.wikipedia.org/wiki/International_organ_donor_rates), retrieved on February 10, 2019, although the data refers to 2017 (source: [IRODaT](http://www.irodat.org/?p=database)).
...
Now let's join and have a look to see what is going on. We use the **countrycode** package to retrieve the ISO3 codes of our scraped dataset:
