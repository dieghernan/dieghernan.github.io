...
Spatial Grids](https://strimas.com/post/hexagonal-grids/) by [Matt
...
<i class="fas fa-exclamation-triangle"></i> **Warning:** The `cellsize`
should be established in the same unit that the projection (in this case
is meters). Pay special attention on this, given that if the parameter
is too small (meaning that the grid is too dense) **R** could crash
easily.
...
![](../assets/img/blog/20190602_squares-1.png)<!-- -->
...
![](../assets/img/blog/20190602_hex-1.png)<!-- -->
...
![](../assets/img/blog/20190602_pix-1.png)<!-- -->
...
![](../assets/img/blog/20190602_functionex-1.png)<!-- -->
