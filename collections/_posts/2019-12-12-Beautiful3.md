---
title: "Beautiful Maps with <strong>R</strong> (III): Patterns and hatched maps"
...
excerpt: On this post I would introduce a couple of functions that may be useful for improving your maps. The goal is to produce different filling patterns that could be added over your shapefiles.
output: 
  md_document:
    variant: gfm
    preserve_yaml: true
